...
class SimpleOop extends personTable
{
    ...
    function create()
    {
        ...
        if (strlen($var1) > 0 && $var2 > 0) {
            /// but somebody still scare if the value is not correct or idiom sql injection
            $statement = $this->connection->prepare("INSERT INTO person VALUES (?, ?,?)");
    ...
    function read()
    {
        // you don't need commit work here ya !
        try {
